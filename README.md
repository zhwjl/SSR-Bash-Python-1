...
## 安装 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/zhwjl/SSR-Bash-Python-1/master/install.sh && bash install.sh

## 卸载 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/zhwjl/SSR-Bash-Python-1/master/uninstall.sh && bash uninstall.sh
    
## 自检 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/zhwjl/SSR-Bash-Python-1/master/self-check.sh && bash self-check.sh
